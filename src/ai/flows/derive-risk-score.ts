...
export async function deriveRiskScore(input: DeriveRiskScoreInput): Promise<DeriveRiskScoreOutput> {
  return deriveRiskScoreFlow(input);
}
...
const deriveRiskScoreFlow = ai.defineFlow(
  {
