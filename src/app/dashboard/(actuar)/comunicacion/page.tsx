    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight uppercase">Comunicación y Difusión</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-surface-dark border-border-dark flex items-center p-6 gap-4">
                    ...
                    <div>
                        <p className="text-2xl font-black text-white">{campañas?.length || 0}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="border-border-dark bg-white/5">
                                        <TableHead className="text-white font-bold">Campaña / Boletín</TableHead>
                                        <TableHead className="text-white font-bold">Medio</TableHead>
                                        <TableHead className="text-white font-bold text-center">Impacto</TableHead>
                                        ...
                                        <TableRow key={c.id} className="border-border-dark hover:bg-white/5 transition-colors text-sm">
                                            ...
                                            <TableCell className="text-center">
                                                <div className="flex flex-col items-center gap-1">
                                                    <span className="text-white font-bold">{c.leidos || 0} / {c.total || 0}</span>
                                            ...
                                            <TableCell className="text-right">
                                                <Button variant="ghost" size="icon" className="text-text-secondary hover:text-white"><Send className="size-4" /></Button>
                                            </TableCell>
                                        </TableRow>
                                    ))}
                                    {campañas?.length === 0 && (
                ...
                <aside className="lg:col-span-4 space-y-6">
                    <Card className="bg-surface-dark border-border-dark">
                        <CardHeader>
                            <CardTitle className="text-white text-sm font-bold uppercase">Canales Activos</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-border-dark">
                                <div className="flex items-center gap-3">
                                    <Mail className="w-4 h-4 text-primary" />
                                    <span className="text-white text-xs font-bold">Email Corporativo</span>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-border-dark">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-white text-xs font-bold">Push Notifications (App)</span>
                                </div>
                                <Badge className="bg-emerald-500">Sincronizado</Badge>
                            </div>
                        </CardContent>
                    ...
                    <div className="bg-primary/10 p-6 rounded-2xl border border-primary/20 relative overflow-hidden">
                        ...
                        <p className="text-white text-sm mt-2 relative z-10">
