...
export default function VehicleDetailPage() {
  ...
  const { data: mantenimientos, error: mantenimientosError } = useCollection(mantenimientosRef);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-surface-dark border-border-dark text-foreground">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div><p className="text-[10px] text-text-secondary font-bold uppercase">Carrocería</p><p className="text-sm">{vehicle.carroceria || 'N/A'}</p></div>
                      <div><p className="text-[10px] text-text-secondary font-bold uppercase">Fecha Fabricación</p><p className="text-sm">{vehicle.fechaFabricacion || 'N/A'}</p></div>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div><p className="text-[10px] text-text-secondary font-bold uppercase">Cilindraje</p><p className="text-sm">{vehicle.cilindraje || 'N/A'}</p></div>
                      <div><p className="text-[10px] text-text-secondary font-bold uppercase">Nro Ejes</p><p className="text-sm">{vehicle.numeroEjes ?? 'N/A'}</p></div>
                      <div><p className="text-[10px] text-text-secondary font-bold uppercase">Capacidad</p><p className="text-sm">{vehicle.capacidad || 'N/A'}</p></div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-surface-dark border-border-dark text-foreground">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-[10px] text-text-secondary font-bold uppercase">KM Mensual Estimado (Real)</p>
                        <p className="text-lg font-black">{vehicle.kilometrajeMensualEstimado?.toLocaleString()} km</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-[10px] text-text-secondary font-bold uppercase">KM Proyectados Mensual (Programado)</p>
                        <p className="text-lg font-black">{vehicle.kmProyectadosMensual?.toLocaleString() || 0} km</p>
                      </div>
                    </div>
